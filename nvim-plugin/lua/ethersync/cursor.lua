...
function M.set_cursor(uri, user_id, name, ranges)
    ...
    if following_userid == user_id then
        follow(user_id)
    end
end
...
function M.follow_cursor()
    ...
    elseif #users == 1 then
        following_userid = users[1]
        follow(following_userid)
    else
